...
میں نے ایک ابتدائی اردو ویب سائٹ کا کوڈ تیار کر دیا ہے جس میں:

خوابوں کی سرچ بار ہے

تعبیر نظر آتی ہے

اگر تعبیر نہ ہو تو رابطہ فارم ظاہر ہوتا ہے

صارف اپنا نام، خواب، اور نمبر/ای میل دے سکتا ہے


آپ اس ویب سائٹ کو HTML فائل میں محفوظ کر کے موبائل یا کمپیوٹر پر چلا سکتے ہیں، یا میں چاہیں تو اسے ایک APK یا Live ویب سائٹ میں تبدیل بھی کر سکتا ہوں۔

کیا آپ چاہتے ہیں کہ میں اسے:

1. APK فائل میں بدل دوں (Android App کے طور پر)


2. یا Live ویب سائٹ بنا کر آپ کو آن لائن لنک دوں؟



آپ کی پسند کے مطابق اگلا قدم اٹھائیں۔
